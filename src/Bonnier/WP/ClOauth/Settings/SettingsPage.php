...
class SettingsPage
{
    const SETTINGS_KEY = 'bp_cl_oauth_settings';
    const SETTINGS_GROUP = 'bp_cl_oauth_settings_group';
    const SETTINGS_SECTION = 'bp_cl_oauth_settings_section';
    const SETTINGS_PAGE = 'bp_cl_oauth_settings_page';
    const API_ENDPOINT_FALLBACK = 'http://woman.dk/';
    const NOTICE_PREFIX = 'Bonnier CL Oauth:';
    const ROLES_PREFIX = 'bp_cl_';
    const ROLE_CAPABILITIES_KEY = 'bp_cl_roles_capabilities';
